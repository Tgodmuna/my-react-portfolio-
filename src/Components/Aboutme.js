        ...
        return (
          <div className={styles.container}>
            ...
            <p className={styles.paragraph}>
              ...
              developer. I recently graduated from {University} in December 16,
              2023{" "}
            </p>
            <p className={styles.paragraph}>
              I am excited to showcase my skills and projects in this portfolio.
              As a developer, I am passionate about using code to create
              beautiful, functional websites that provide a great user
            ...
            <p className={styles.paragraph}>
              ...
              demonstrates my passion for front-end development. Whether you are
              a potential employer, a fellow developer, or someone who simply
              appreciates good design, I welcome your feedback and look forward
            ...
            <p className={styles.paragraph}>
              ...
              honing my skills and creating projects that showcase my abilities.
              Using ReactJS, I have developed several applications, including a
              weather app, a temperature converter, a todo app, and an age
              converter. In addition, I have built my own portfolio website
              using ReactJS to demonstrate my capabilities and highlight my
              passion for frontend development.
            </p>{" "}
            <p className={styles.paragraph}>
              While I have not yet had formal work experience, my focus on
              self-improvement and commitment to learning new skills demonstrate
              my strong work ethic and desire to excel in my chosen field. I am
              confident that with the right opportunity, I can leverage my
              skills and make valuable contributions as a frontend developer.
            </p>{" "}
            <p className={styles.paragraph}>
              Overall, my experience summary highlights my dedication to
              self-development, passion for frontend development, and potential
