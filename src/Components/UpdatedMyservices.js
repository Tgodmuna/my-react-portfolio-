      ...
      <div className={styles.servicesList}>
        ...
        <div className={styles.service}>
          ...
          <p>
            ...
            user-friendly interfaces using modern web technologies such as HTML,
            CSS, and JavaScript(reactJs,reducx,router).
          </p>
          <ul className={styles.ex}>
...
export default UpdatedMyservices;
